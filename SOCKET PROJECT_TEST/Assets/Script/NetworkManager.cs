...
public class NetworkManager : MonoBehaviour {
    ...
    public InputField playerPwordInput;
    ...
    void Start () {
        ...
        socket.On("other player disconnected", OnOtherPlayerDisonnected);
    }
    ...
    IEnumerator ConnectToServer()
    {
        ...
        string playerPword = playerPwordInput.text;
        List<SpawnPoint> playerSpawnPoints = GetComponent<PlayerSpawner>().playerSpawnPoints;
        List<SpawnPoint> enemySpawnPoints = GetComponent<EnemySpawner>().enemySpawnPoints;
        PlayerJSON playerJSON = new PlayerJSON(playerName,playerPword, playerSpawnPoints, enemySpawnPoints);
    ...
    void OnOtherPlayerDisonnected(SocketIOEvent socketIOEvent)
    {
    ...
    public class PlayerJSON
    {
        ...
        public PlayerJSON(string _name,string _pword, List<SpawnPoint> _playerSpawnPoints, List<SpawnPoint> _enemySpawnPoints)
        {
